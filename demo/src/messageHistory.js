export default [
  {
    ...
    author: `me`,
    id: 0,
    data: {text: `Why don't they have salsa on the table?`, sent: false}
  },
  {type: 'text', author: `mattmezza`, id: 1, data: {text: `What do you need salsa for?`}},
  {
    ...
    author: `me`,
    id: 2,
    data: {text: `Salsa is now the number one condiment in America.`, sent: false}
  },
  {
    type: 'text',
    author: `mattmezza`,
  ...
  },
  {
    ...
    author: `me`,
    id: 6,
    data: {text: `See, this should be a show. This is the show. `, sent: true}
  },
  {type: 'text', author: `mattmezza`, id: 7, data: {text: `What?`}},
  {type: 'text', author: `me`, id: 8, data: {text: `This. Just talking.`, sent: true}},
  {type: 'text', author: `mattmezza`, id: 9, data: {text: `Yeah, right.`}},
  {
    type: 'text',
    author: `me`,
    id: 10,
    data: {text: `I'm really serious. I think that's a good idea. `, sent: true}
  },
  {
    type: 'text',
    author: `mattmezza`,
  ...
  {type: 'text', author: `me`, id: 12, data: {text: `It's about nothing.`, sent: true}},
  ...
  {type: 'emoji', author: `me`, id: 17, data: {emoji: `😋`, sent: true}},
  {
    type: 'text',
    author: `me`,
    id: 18,
    data: {text: `Do you read me...`, meta: '✓✓ Read', sent: true}
  },
  {
    type: 'text',
    author: `me`,
    id: 19,
    data: {text: `...or not?`, meta: '✓ Delivered', sent: false}
  },
